...
|Arduino (input devices) | 增加对应的Arduino 代码|20201101|wait |
|Arduino (input devices) | 在课程日志部分增加标题和链接，链接至（http://team-924.gitlab.io/zjucst924/log-3.html）|20201101| wait|
|Arduino IOT |等待更新|20201101|wait |
...
| Open source hardware and Arduino basic  | 电路的接线图（可以使用[Tinkercad](https://www.tinkercad.com/)或者[Fritzing](https://fritzing.org/)） ，文档中用视频或者gif展示阶段性成果，另外写出优化建议     |20201101| Wait |
...
| Project management  |   Zhou Jiangping的web链接|20201101| Wait |
...
| Arduino (input devices)   |  待更新   |20201101| Wait |
|  Arduino (output devices) |  增加最终效果的视频   |20201101| Wait |
|  Arduino IOT |  待更新   |20201101| Wait |
...
| Arduino (input devices)   |  电路的接线图错误   |20201101| Wait |
...
| ------------- | ------------- |:-------------:| -----:|
| Project management  |    在课程日志中增加网站搭建方式（图文），使用工具，参考资料|20201101| Wait |
| Project management  |   wanghan 的介绍页面|20201101| Wait |
| Open source hardware and Arduino basic  |     |20201101| OK |
...
|Topic|    Question        | time           | Condation  |	
| ------------- | ------------- |:-------------:| -----:|
| Project management  | 优化按钮链接，删除不必要的首页内容，个人和团队介绍可以稍微详细   在课程日志中增加网站搭建方式（图文），使用工具，参考资料|20201101| Wait |
| Project management  | member和每周作业的布局逻辑优化|20201101| Wait |
| Open source hardware and Arduino basic  | 第二周，入门Arduino的标题可以改为Arduino系列    |20201101| wait |
...
| Project management  |    在课程日志中增加网站搭建方式（图文），使用工具，参考资料|20201101| Wait |
| Project management  |   人员介绍页面“back”不稳定：邵雅平，李悉晨，陈家妍|20201101| Wait |
| Project management  |   三个web搭建方式对比图表待优化内容|20201101| Wait |
| Project management  |   all project just "project2" and "project 3"|20201101| Wait |
| Open source hardware and Arduino basic  |  视频尺寸可以尝试扩大，   |20201101| Wait |
| Open source hardware and Arduino basic  |  conclusion English   |20201101| Wait |
| Open source hardware and Arduino basic  |  conclusion3:图文解释下，一起解决  |20201101| Wait |
| Open source hardware and Arduino basic  |  名字定义，steering gear  to  servo motor  |20201101| Wait |
| Arduino (input devices)   |     |20201101| Wait |
|  Arduino (output devices) |   硬币项目代码共享到云端，增加链接  |20201101| Wait |
|  Arduino (output devices) |   增加32*16点阵板链接  |20201101| Wait |
...
| Introduction of design engineering | |20201101|OK|
| Project management  |    在课程日志中增加网站搭建方式（图文），使用工具，参考资料|20201101| Wait |
| Project management  |    web页面5blogs |20201101| Wait |
| Project management  |    5blogs|20201101| Wait |
|  Arduino IOT |  待更新   |20201101| Wait |